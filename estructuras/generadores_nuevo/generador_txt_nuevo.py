"""
Generador específico para archivos TXT de estructuras nuevas.
"""
...
class GeneradorTxtNuevo(GeneradorBase):
    """Genera archivos TXT para estructuras nuevas"""
    
    def generar(self, datos: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
        Genera archivo TXT para estructuras nuevas
        ...
        """
        filename = self.generar_nombre_archivo_con_indice('estructuras_nuevo', 'txt')
